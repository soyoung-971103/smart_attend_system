...
<!------------------------------------------------------------------------------>
				...
				<script>
					...
					{	
						...
						var timetable=
							'${item2.lecture.subject.grade}^${item2.lecture._class}^${item2.timetable.weekday}^${item2.timetable.istart}^${item2.timetable.ihour}^${item2.lecture.subject.name}^${item2.lecture.teacher.name}^${item2.room.name}';
