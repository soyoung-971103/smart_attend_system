...
<head>
	...
	<link href="my/css/login.css" rel="stylesheet">
    <link href="my/css/bootstrap-checkbox.css" rel="stylesheet">
	...
	<div class="row h-100 justify-content-center align-items-center">
		...
		<div class="card">
			...
			<div class="card-body" style="padding:10px">
				...
				<form data-toggle="validator" role="form" method="post" action="member-login.do">
					...
					<div class="form-inline">
						...
						<input type="radio" name="login_kind" value="assist">&nbsp;조교&nbsp;&nbsp;&nbsp;
						<input type="radio" name="login_kind" value="admin" checked>&nbsp;직원
					</div>
					<br>
					<div class="row">
						<div class="col-md-12">
