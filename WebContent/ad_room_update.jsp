					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="card mb-3">
							<div class="card-header mycolor3" style="padding:10px">
								<h3><i class="fa fa-table"></i> 강의실 수정</h3>
							</div>
								
							<div class="card-body" style="padding:10px">

								<form name="form1" method="post" action="room-update.do">
								<input type="hidden" name="id" value="${room.id }" class="form-control form-control-sm" required>
											...
											<div class="form-inline">
												<select name="building_id" class="form-control form-control-sm">
													<c:forEach var="building" items="${listBuilding}">
														<c:choose>
															<c:when test="${room.building_id == building.id}">	
											...
											<div class="form-inline">
												<select name="depart_id" class="form-control form-control-sm">
													...
													<c:forEach var="depart" items="${listDepart}">
														<c:choose>
															<c:when test="${room.depart_id == depart.id}">	
