...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
 ...
 <!-- 
<c:set var="dropUl" value="${fn:split('','')}" />
<c:set var="dropA" value="${fn:split('','')}" />
<c:set var="activA" value="${fn:split('','')}" />
-->
...
<%
	...
	//직원(학사행정)
	if (url.equals("/ad_main.jsp")) {
		dropUl[0] = "display:block";
		dropA[0] = "subdrop";
		activA[0][0] = "subdrop";
	}
	else if (url.equals("/ad_control.jsp")) {
		dropUl[0] = "display:block";
		dropA[0] = "subdrop";
		activA[0][1] = "subdrop";
	}
	...
	//직원(전자출석)
	else if (url.equals("/ad_timeall.jsp")) {
		dropUl[1] = "display:block";
		dropA[1] = "subdrop";
		activA[1][0] = "subdrop";
	}
	else if (url.equals("/ad_timeteacher.jsp")) {
		dropUl[1] = "display:block";
		dropA[1] = "subdrop";
		activA[1][1] = "subdrop";
	}
	...
	//조교
	else if (url.equals("/as_main.jsp")) {
		dropUl[2] = "display:block";
		dropA[2] = "subdrop";
		activA[2][0] = "subdrop";
	}
	else if (url.equals("/as_sub.jsp")) {
		dropUl[2] = "display:block";
		dropA[2] = "subdrop";
		activA[2][1] = "subdrop";
	}
	...
	//교수
	else if (url.equals("/te_main.jsp")) {
	...
	//학생
	else if (url.equals("/st_main.jsp")) {
		dropUl[3] = "display:block";
		dropA[4] = "subdrop";
		activA[4][0] = "subdrop";
	}
				...
				<ul>
					...
					<li class="submenu">
						...
						<ul class="list-unstyled">
							...
							<li><a href="student-qna.do" style="padding:5px 0 5px 40px;">교과목 문의</a></li>
						</ul>
					</li>
				...
				<ul>
					<li class="submenu"><a href="#"
						class="<c:out value="${dropA[0]}"/>"><i
							class="fa fa-fw fa-table"></i> <span> 직원(학사행정)/></span> <span class="menu-arrow"></span></a>
						<ul class="list-unstyled" style="<c:out value="${dropUl[0]}"/>">
							<li><a href="ad_main.html" class="<c:out value="${activA[0][0]}"/>" style="padding: 5px 0 5px 40px;">직원메인</a></li>
							<li><a href="ad_control.html" class="<c:out value="${activA[0][1]}"/>" style="padding: 5px 0 5px 40px;">제어판</a></li>
							<li><a href="notice-list.do" class="<c:out value="${activA[0][2]}"/>" style="padding: 5px 0 5px 40px;">공지사항</a></li>
							<li><hr style="background-color: gray; margin: 0 25px 0 25px;"></li>
							<li><a href="student-list.do" class="<c:out value="${activA[0][3]}"/>" style="padding: 5px 0 5px 40px;">학생정보</a></li>
							<li><a href="teacher-list.do" class="<c:out value="${activA[0][4]}"/>" style="padding: 5px 0 5px 40px;">교수정보</a></li>
							<li><a href="assist-list.do" class="<c:out value="${activA[0][5]}"/>" style="padding: 5px 0 5px 40px;">조교정보</a></li>
							<li><hr style="background-color: gray; margin: 0 25px 0 25px;"></li>
							<li><a href="depart-list.do" class="<c:out value="${activA[0][6]}"/>" style="padding: 5px 0 5px 40px;">학과/부서</a></li>
							<li><a href="room-list.do" class="<c:out value="${activA[0][7]}"/>" style="padding: 5px 0 5px 40px;">강의실</a></li>
							<li><a href="building-list.do" class="<c:out value="${activA[0][8]}"/>" style="padding: 5px 0 5px 40px;">건물</a></li>
							<li><a href="holiday-list.do" class="<c:out value="${activA[0][9]}"/>" style="padding: 5px 0 5px 40px;">휴일</a></li>
						</ul></li>
					<li class="submenu"><a href="#"
						...
						<ul class="list-unstyled" style="<c:out value="${dropUl[1]}"/>">
							<li><a href="ad_timeall.html" class="<c:out value="${activA[1][0]}"/>" style="padding: 5px 0 5px 40px;">학과별시간표</a></li>
							<li><a href="ad_timeteacher.html" class="<c:out value="${activA[1][2]}"/>" style="padding: 5px 0 5px 40px;">교수별강의현황</a></li>
							<li><a href="ad_lecmove.html" class="<c:out value="${activA[1][3]}"/>" style="padding: 5px 0 5px 40px;">휴보강</a></li>
						</ul></li>
					<li class="submenu"><a href="#"><i class="fa fa-fw fa-male"
							class="<c:out value="${dropA[2]}"/>"></i> <span>조교</span> <span
							class="menu-arrow"></span></a>
						<ul class="list-unstyled" style="<c:out value="${dropUl[2]}"/>">
							<li><a href="as_main.html" class="<c:out value="${activA[2][0]}"/>" style="padding: 5px 0 5px 40px;">조교 메인</a></li>
							<li><a href="subject-list.do" class="<c:out value="${activA[2][1]}"/>" style="padding: 5px 0 5px 40px;">학년별 교과목</a></li>
							<li><a href="as-lecture-list.do" class="<c:out value="${activA[2][2]}"/>" style="padding: 5px 0 5px 40px;">반별 교과목</a></li>
							<li><a href="timetable-list.do" class="<c:out value="${activA[2][3]}"/>" style="padding: 5px 0 5px 40px;">시간표작성</a></li>
							<li><a href="as-timetable-all.do" class="<c:out value="${activA[2][4]}"/>" style="padding: 5px 0 5px 40px;">학과별 시간표</a></li>
							<li><a href="lecture-sublecture.do" class="<c:out value="${activA[2][5]}"/>" style="padding: 5px 0 5px 40px;">과목별 출석부</a></li>
							<li><a href="as_lecmove.html" class="<c:out value="${activA[2][6]}"/>" style="padding: 5px 0 5px 40px;">휴보강</a></li>
						</ul></li>
					<li class="submenu"><a href="#"><i class="fa fa-fw fa-user"
							class="<c:out value="${dropA[3]}"/>"></i> <span> 교수 </span> <span
							class="menu-arrow"></span></a>
						<ul class="list-unstyled" style="<c:out value="${dropUl[3]}"/>">
							<li><a href="te_main.html" class="<c:out value="${activA[3][0]}"/>" style="padding: 5px 0 5px 40px;">교수 메인</a></li>
							<li><a href="timetable-tdetail.do" class="<c:out value="${activA[3][1]}"/>" style="padding: 5px 0 5px 40px;">시간표</a></li>
							<li><a href="te_lec.jsp" class="<c:out value="${activA[3][2]}"/>" style="padding: 5px 0 5px 40px;">일별 출석부</a></li>
							<li><a href="te-lecall.do" class="<c:out value="${activA[3][3]}"/>" style="padding: 5px 0 5px 40px;">과목별 출석부</a></li>
							<li><a href="te_lecmove.html" class="<c:out value="${activA[3][4]}"/>" style="padding: 5px 0 5px 40px;">휴보강</a></li>
							<li><a href="te_lecqa.html" class="<c:out value="${activA[3][5]}"/>" style="padding: 5px 0 5px 40px;">교과목 문의</a></li>
						</ul></li>
					<li class="submenu"><a href="#"
						...
						<ul class="list-unstyled" style="<c:out value="${dropUl[4]}"/>">
							<li><a href="st_main.html" class="<c:out value="${activA[4][0]}"/>" style="padding: 5px 0 5px 40px;">학생 메인</a></li>
							<li><a href="mylecture-sdetail.do" class="<c:out value="${activA[4][1]}"/>" style="padding: 5px 0 5px 40px;">시간표</a></li>
							<li><a href="lecture-mylecture.do" class="<c:out value="${activA[4][2]}"/>" style="padding: 5px 0 5px 40px;">출석부</a></li>
							<li><hr style="background-color: gray; margin: 0 25px 0 25px;"></li>
							<li><a href="lecture-list.do" class="<c:out value="${activA[4][3]}"/>" style="padding: 5px 0 5px 40px;">수강신청</a></li>
							<li><a href="st_lecsj.html" class="<c:out value="${activA[4][4]}"/>" style="padding: 5px 0 5px 40px;">수강과목</a></li>
							<li><a href="st_lecqa.html" class="<c:out value="${activA[4][5]}"/>" style="padding: 5px 0 5px 40px;">교과목
									문의</a></li>
						</ul></li>
