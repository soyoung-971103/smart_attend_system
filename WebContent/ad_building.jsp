							...
							<div class="card-body" style="padding:10px">
								...
								<div class="row" style="margin-bottom:5px">
									...
									<div class="col" align="right">
										<a href="ad_buildingnew.html" class="btn btn-sm mycolor1">추가</a>
									</div>
								</div>
								</form>
								...
								<table class="table table-bordered table-hover mytable" style="width:100%">
									...
									<tbody>
										<tr>
											...
											<td>5층</td>
											<td>
												<a href="subject_edit.html" class="btn btn-xs btn-outline-primary">수정</a>
												<a href="subject_del.html" class="btn btn-xs btn-outline-danger" onClick="return confirm('삭제할까요 ?');">삭제</a>
											</td>
										</tr>
										<tr>
											<td>덕관</td>
